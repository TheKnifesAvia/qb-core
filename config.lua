...
QBConfig.MaxPlayers = GetConvarInt('sv_maxclients', 36) -- Gets max players from config file, default 48
QBConfig.DefaultSpawn = vector4(223.78, -876.11, 30.49, 345.36)
...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 500, bank = 25000, crypto = 10, dirty = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
QBConfig.Money.DontAllowMinus = { 'cash', 'crypto', 'dirty' } -- Money that is not allowed going in minus
